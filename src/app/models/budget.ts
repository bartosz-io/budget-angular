...
export class Budget {
  ...
  get leftPercentage(): string { return 100 * this.currentExpenses / this.maxExpenses + '%'; }
  ...
  static buildFromDefinition(accountId: Id, period: Period, definition: BudgetDefinition): Budget {
    const budget = new Budget();
