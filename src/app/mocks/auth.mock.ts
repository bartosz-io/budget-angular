...
export const tokens = {
  'bartosz@app.com' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.'
  ...
  'john@app.com' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.'
  ...
  'mike@app.com' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.'
