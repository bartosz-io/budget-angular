...
export class BudgetApi {
  ...
  getBudgets(period: Period): Observable<Budget[]> {
    return this.http.get(`${this.apiUrl}/budgets/?month=${period.month}&year=${period.year}`)
  ...
  getBudgetSummary(period: Period): Observable<BudgetSummary> {
    return this.http.get<BudgetSummary>(`${this.apiUrl}/budget-summary/?month=${period.month}&year=${period.year}`)
